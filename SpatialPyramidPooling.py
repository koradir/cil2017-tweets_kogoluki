...
# -*- coding: utf-8 -*-
"""
The following is an implementation of Kaiming et al.'s Spatial Pyramid Pooling,
(cf. https://arxiv.org/pdf/1406.4729.pdf)

The SPP layer is supposed to be inserted between the convolutional part of the
CNN and the first fully-connected layer. Fully-connected layers expect a fixed
input size and SPP generates an output of fixed size from a dynamic input size.

Original implementation by github user "luizgh" for theano + lasagne
(cf. https://github.com/luizgh/Lasagne/commit/c01e3d922a5712ca4c54617a15a794c23746ac8c)
